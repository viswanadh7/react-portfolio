...
function Main() {
    ...
    function ProjectCard({ url, name, link }) {
        return (
            <div style={{ backgroundSize: "cover", backgroundImage: `url(${url})` }} className='h-80 w-full text-center hover:scale-105 duration-300 hover:shadow-lg hover:shadow-black rounded-2xl'>
    ...
    return (
        <>
            <Navbar />
            <section id='home' className='min-h-screen md:h-screen grid md:grid-cols-2 items-center justify-items-center p-10 gap-5 md:gap-10 lg:gap-20'>
                <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} transition={{ duration: 0.5 }} className='md:order-2 mt-10 md:mt-0'>
            ...
            <section id='about' className='h-fit grid grid-cols-1 lg:grid-cols-2 gap-20 p-10 md:p-10'>
                ...
                <div className='overflow-x-hidden'>
                    ...
                    <motion.ul animate={skill ? 'open' : 'closed'} variants={skillVariants} className='grid grid-cols-3 sm:place-items-center lg:place-items-start gap-10 md:gap-20 mt-10 text-xl font-light'>
                        <li>HTML</li>
                        <li>CSS</li>
                        <li>JavaScript</li>
                        <li>Bootstrap</li>
            ...
            <section id='contact' className='h-fit'>
                <div className='p-10 grid grid-cols-1 md:grid-cols-2 md:gap-20'>
                    ...
                    <div className='mt-10 md:mt-0'>
                        <form onSubmit={(e) => e.preventDefault()} className='p-5 border border-black rounded-2xl shadow-xl' action="">
                            <label className='text-lg mb-3' htmlFor="name">Name</label><br />
                            <input required className='border border-black rounded-md px-3 py-2 mb-5 w-full' placeholder='Enter your name' type="text" /><br />

                            <label className='text-lg mb-3' htmlFor="email">Email</label><br />
                            <input required className='border border-black rounded-md px-3 py-2 mb-5 w-full' placeholder='Enter your email' type="email" /><br />

                            <label className='text-lg mb-3' htmlFor="message">Message</label><br />
                            <textarea className='border border-black rounded-md px-3 py-2 mb-5 w-full' placeholder='Write your message here' name="" id=""></textarea><br />
